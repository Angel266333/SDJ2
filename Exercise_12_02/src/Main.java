...
import starSigns.Person;
import starSigns.StarSign;
import starSigns.StarSignWithInterpretation;
...
public class Main {
	public static void main(String[] args) {
		...
		list[6] = new Person("Graham", new StarSignWithInterpretation("Sagittarius", Calendar.getInstance(), "Poland"));
